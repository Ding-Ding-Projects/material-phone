...
- Replaced the hosted-dead MSYS2 `tar.xz` expansion path with the pinned official self-extracting archive, bounded execution heartbeats, and exact root/command validation before the existing same-volume staging step.
